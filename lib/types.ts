...
const PREDEFINED_EXERCISES_RAW: Omit<ExerciseMetadata, 'id'>[] = [
  ...
  { name: 'Deadlift (Barbell)', primaryMuscle: 'hamstring', secondaryMuscles: ['gluteal', 'lower-back', 'quadriceps'], exerciseType: 'weighted', muscleContributions: { hamstring: 35, gluteal: 30, 'lower-back': 25, quadriceps: 10 } },
  { name: 'Deadlift (Romanian)', primaryMuscle: 'hamstring', secondaryMuscles: ['gluteal', 'lower-back'], exerciseType: 'weighted', muscleContributions: { hamstring: 50, gluteal: 30, 'lower-back': 20 } },
  ...
  { name: 'Squat (Barbell)', primaryMuscle: 'quadriceps', secondaryMuscles: ['gluteal', 'hamstring'], exerciseType: 'weighted', muscleContributions: { quadriceps: 50, gluteal: 30, hamstring: 20 } },
  { name: 'Squat (Goblet)', primaryMuscle: 'quadriceps', secondaryMuscles: ['gluteal', 'abs'], exerciseType: 'weighted', muscleContributions: { quadriceps: 60, gluteal: 25, abs: 15 } },
